        ...
        <Layout className="pt-16">
          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            <div className="col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8">
              ...
              <p className="font-medium">
                I believe that excellent design and thoughtful engineering are essential for creating intuitive, enjoyable user experiences. Whether I’m building a new feature, optimizing a product’s performance, or mentoring junior engineers, I’m always focused on delivering high-quality results and continuously improving my craft.
              </p>
            </div>
            ...
            <div className="col-span-2 flex flex-col items-end justify-between xl:col-span-8 xl:flex-row xl:items-center md:order-3">
              ...
              <div className="flex flex-col items-end justify-center xl:items-center">
                <span className="inline-block text-7xl font-bold md:text-6xl sm:text-5xl xs:text-4xl">
                  <AnimatedNumberFramerMotion value={800} />+
                </span>
                <h2 className="mb-4 text-xl font-medium capitalize text-dark/75 dark:text-light/75 xl:text-center md:text-lg sm:text-base xs:text-sm">
                  Cups of coffee
                </h2>
